...
@Component({
  selector: 'app-list-student-ttb',
  templateUrl: './list-student-ttb.component.html',
  styleUrls: ['./list-student-ttb.component.scss']
})
export class ListStudentTTBComponent implements OnInit {
  listStudent: any[] = []
