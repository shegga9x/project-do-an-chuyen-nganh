...
import { EntityLoadReponse } from 'src/app/models/entityLoadReponse';
import { PDTService } from 'src/app/services';

@Component({
  selector: 'app-manage-entites',
  templateUrl: './manage-entites.component.html',
  styleUrls: ['./manage-entites.component.scss']
})
export class ManageEntitesComponent implements OnInit {
